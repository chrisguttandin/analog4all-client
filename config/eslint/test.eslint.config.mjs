...
export default defineConfig([
    ...
    },
    {
        files: ['**/*.ts'],
        rules: {
            '@angular-eslint/component-selector': ['error', { prefix: 'anc', style: 'kebab-case', type: 'element' }],
            '@angular-eslint/directive-selector': ['error', { prefix: 'anc', style: 'camelCase', type: 'attribute' }],
