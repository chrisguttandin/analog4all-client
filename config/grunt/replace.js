        ...
        'manifest': {
            ...
            options: {
                patterns: [ {
                    ...
                    match: /[\s]*"\/analog4all-client(\/scripts)?\/runtime\.[a-z0-9]+.js",/g,
                    replacement: ''
                }, {
                    match: /[\s]*"\/analog4all-client(\/scripts)?\/runtime\.[a-z0-9]+.js":\s"[a-z0-9]+",/g,
                    replacement: ''
                }, {
                    // Replace the hash value inside of the hashTable for "/scripts/main.*.js" because it was modified before.
                    match: /"\/analog4all-client(\/scripts\/main\.[a-z0-9]+.js)":\s"[a-z0-9]+"/g,
