...
module.exports = (grunt) => {
    return {
        ...
        'manifest': {
            ...
            options: {
                patterns: [ {
                    ...
                    match: /[\s]*"\/analog4all-client(\/scripts)?\/runtime-(?:es2015|es5)\.[a-z0-9]*\.js",/g,
                    replacement: ''
                }, {
                    match: /[\s]*"\/analog4all-client(\/scripts)?\/runtime-(?:es2015|es5)\.[a-z0-9]*\.js":\s"[a-z0-9]+",/g,
                    replacement: ''
                }, {
                    // Replace the hash value inside of the hashTable for "/scripts/main.*.js" because it was modified before.
                    match: /"\/analog4all-client(\/scripts\/main-(?:es2015|es5)\.[a-z0-9]+.js)":\s"[a-z0-9]+"/g,
        ...
        'runtime': {
            ...
            options: {
                patterns: [ {
                    match: /<script\ssrc="(runtime-(?:es2015|es5)\.[a-z0-9]*\.js)"(\s(nomodule|type="module"))\sintegrity="sha384-[a-zA-Z0-9+/]*=*"\scrossorigin="anonymous"><\/script>/g,
