module.exports = {
    ...
    build: {
        cmd: 'ng build --aot --base-href https://chrisguttandin.github.io/analog4all-client --build-optimizer --no-sourcemaps --prod --stats-json && webpack-stats-duplicates build/stats.json && rm build/stats.json'
    },
    continuous: {
        cmd: 'ng test'
    },
